...
La estructura de rsync es cl\'asica: \emph{comando \emph{opciones origen \emph{destino}
...
Esta unit tiene una secci\'on \emph{[Install]} que las otras no necesitaban. Aqu\'i encontramos la informaci\'on que systemctl necesita para \emph{instalar} este servicio (ver \ref{itm:wantedBy}).
\begin{description}
